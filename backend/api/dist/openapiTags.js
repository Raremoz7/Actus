...
export const OPENAPI_TAGS = [
    ...
    { name: "Gamificação", description: "Streak, timeline semanal e desafios (aluno e profissional)" },
    ...
    { name: "Profissional — desafios", description: "Desafios, convites e relatórios (apenas personal)" },
