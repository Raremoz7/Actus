...
const { motion, colors, spacing, layout } = darkTheme;
            ...
            mutations.markExercise.mutate(exercise.workout_exercise_id, {
              ...
              onError: (err) => {
                Alert.alert(
                  ...
                  `A série foi salva, mas não deu para marcar o exercício como concluído: ${apiErrorMessage(err)}`,
                );
              },
            });
          }
...
function Overview({
  ...
  return (
    <ScrollView
      contentContainerStyle={[styles.scroll, { paddingBottom: layout.tabBarSafePaddingSm + insetsBottom }]}
...
function Logging({
  ...
  return (
    <View style={styles.flex}>
      <ScrollView
        contentContainerStyle={[styles.logScroll, { paddingBottom: layout.tabBarSafePaddingSm + insetsBottom }]}
        showsVerticalScrollIndicator={false}
      >
        <AppText variant="eyebrow" color="tertiary">
          {positionLabel}
...
const styles = StyleSheet.create((theme) => ({
  ...
  scroll: { paddingHorizontal: theme.spacing.lg, paddingBottom: theme.layout.tabBarSafePaddingSm },
  ...
  logScroll: {
    paddingHorizontal: theme.spacing.lg,
    paddingTop: theme.spacing.lg,
    paddingBottom: theme.layout.tabBarSafePaddingSm,
  },
