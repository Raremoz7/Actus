        ...
        >
          ...
          <View style={styles.body}>
            ...
            {hasPrescription || hasRest ? (
              <Card padding="lg" style={styles.prescriptionExtra}>
                {hasPrescription ? (
              ...
              <View style={styles.nav}>
                {prev ? (
                  <Card
                    ...
                    padding="md"
                    style={[styles.navBtnExtra, styles.navPrev]}
                    onPress={() => goTo(prev)}
                  >
                ...
                {next ? (
                  <Card
                    ...
                    padding="md"
                    style={[styles.navBtnExtra, styles.navNext]}
                    onPress={() => goTo(next)}
                  >
                    <AppText variant="metaSmall" color="secondary" numberOfLines={1} style={styles.navText}>
                      {next.name_snapshot}
