...
import { AppText, Button, Card, Input, Tag } from '@/components/ui';
  ...
  function handleGenerate() {
    create.mutate(
      { expiresAt: isoInDays(expiryDays), maxUses },
      {
        ...
        onError: (err) => {
          Alert.alert('Não foi possível gerar', apiErrorMessage(err));
        },
      },
    );
  }
        ...
        <Animated.View style={[styles.flex, revealStyle]}>
          {isShareView ? (
            ...
            <View style={styles.body}>
              ...
              <Card padding="lg" style={styles.codeCardExtra}>
                <AppText variant="eyebrow" color="tertiary">
                  Código
                </AppText>
