...
// contentStyle nativo do Stack não roda dentro de StyleSheet.create — usa o token direto.
export const STACK_BG = darkTheme.colors.bgLowest;
...
export function RootNavigator() {
  return (
    ...
    >
      ...
      <RootStack.Screen name={AREAS.auth} component={AuthArea} />
      <RootStack.Screen name={AREAS.aluno} component={AlunoArea} />
      <RootStack.Screen name={AREAS.personal} component={PersonalArea} />
      <RootStack.Screen name={AREAS.nutri} component={NutriArea} />
      <RootStack.Screen name={AREAS.onboardingAluno} component={OnboardingAlunoArea} />
      <RootStack.Screen name={AREAS.onboardingProfessor} component={OnboardingProfessorArea} />

      <RootStack.Screen name="AlunoDetail" component={AlunoDetailScreen} />
      <RootStack.Screen name="AtribuirDieta" component={AtribuirDietaScreen} />
      <RootStack.Screen name="AtribuirTreino" component={AtribuirTreinoScreen} />
      <RootStack.Screen name="BancoTreino" component={BancoTreinoScreen} />
      <RootStack.Screen name="Convite" component={ConviteScreen} />
      <RootStack.Screen name="ConviteNovo" component={ConviteNovoScreen} />
      <RootStack.Screen name="CriarDesafio" component={CriarDesafioScreen} />
      <RootStack.Screen name="DesafioPro" component={DesafioProScreen} />
      <RootStack.Screen name="EditarPerfil" component={EditarPerfilScreen} />
      <RootStack.Screen name="MontarDieta" component={MontarDietaScreen} />
      <RootStack.Screen name="MontarTreino" component={MontarTreinoScreen} />
      <RootStack.Screen name="Register" component={RegisterScreen} />
      <RootStack.Screen name="UsarConvite" component={UsarConviteScreen} />
      <RootStack.Screen name="DevHealth" component={DevHealthScreen} />
