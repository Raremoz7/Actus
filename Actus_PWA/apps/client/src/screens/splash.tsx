...
export default function SplashScreenRoute() {
  ...
  useEffect(() => {
    ...
    if (status === 'unauthenticated') {
      // Deslogado: entra pela landing (porta de entrada do sistema). Daí o usuário
      // segue para login/cadastro. (AUTH_ENTRY segue sendo o destino dos guards de
      // rota protegida acessada diretamente sem sessão.)
